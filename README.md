...
```
cd existing_repo
git remote add origin https://gitlab.csi.miamioh.edu/avilaoe/cse383_final.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.csi.miamioh.edu/avilaoe/cse383_final/-/settings/integrations)
